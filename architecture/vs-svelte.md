...
>
> **Примечание:** Agdelte находится в стадии MVP. Примеры кода демонстрируют целевой API — некоторые комбинаторы (`snapshot`, `debounce`, etc.) ещё не реализованы.
...
│  MVP: простые реализации                                │
│  Phase 2+: Poly внутри (гарантии by construction)       │
├─────────────────────────────────────────────────────────┤
│  ТЕОРИЯ (Theory/): Poly, Coalg, Lens                   │
│  Формальное соответствие: Signal ≅ Coalg, App ≅ Coalg  │
│  Изолирована, для доказательств и продвинутых задач     │
└─────────────────────────────────────────────────────────┘
```

Svelte строит абстракции "снизу вверх" — от DOM к компонентам. Agdelte строит "сверху вниз" — от простого DSL к математической теории. Простые определения для пользователя; теория (в отдельном модуле) для гарантий.
