...
>
> **Статус:** Phase 2 завершён. Все основные примитивы реализованы.
>
> | Примитив | Статус |
> |----------|--------|
> | interval | ✅ |
...
> | debounce, throttle | ✅ |
> | routing (onUrlChange, pushUrl) | ✅ |
> | localStorage | ✅ |
> | DOM (focus, scrollTo, clipboard) | ✅ |
...
**Семантика:** request генерирует ровно одно событие (ответ или ошибка). После этого примитив молчит.
