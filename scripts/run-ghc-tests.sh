...
TESTS=(test:im test:crmwire test:crmstore test:crmcommands test:walrec test:json-ffi test:store-txn test:psych-schedule test:rbac test:authz-store test:yookassa test:schema-spike)
