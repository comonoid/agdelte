...
-- Task: demonstration of monadic HTTP request chains
-- Shows do-notation for composing Tasks
...
record Model : Set where
  ...
  field
    status    : Status
    stepInfo  : String  -- current step for display
...
-- Chain of three requests with do-notation
